# Generated by Django 3.0.6 on 2020-05-19 15:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='howru_models.Doctor')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ...
                ('language', models.CharField(choices=[('GB', 'English'), ('ES', 'Spanish')], max_length=2)),
                ('creator_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='howru_models.Doctor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='howru_models.Doctor')),
